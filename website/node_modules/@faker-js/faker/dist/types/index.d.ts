...
export type { DateModule, SimpleDateModule } from '@faker-js/faker/modules/date';
...
export type { HelpersModule, SimpleHelpersModule } from '@faker-js/faker/modules/helpers';
...
export { SimpleFaker, simpleFaker } from '@faker-js/faker/simple-faker';
